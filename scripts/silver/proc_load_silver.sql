...
-- ===================================================
-- 終極成果：只用一張表吐出所有計時與筆數統計！
-- ===================================================
SELECT 'crm_cust_info' AS `Table Name`, COUNT(*) AS `Row Count`, CONCAT(@t1_duration, ' sec') AS `Load Duration` FROM silver.crm_cust_info
UNION ALL
SELECT 'crm_prd_info', COUNT(*), CONCAT(@t2_duration, ' sec') FROM silver.crm_prd_info
UNION ALL
SELECT 'crm_sales_details', COUNT(*), CONCAT(@t3_duration, ' sec') FROM silver.crm_sales_details
UNION ALL
SELECT 'erp_CUST_AZ12', COUNT(*), CONCAT(@t4_duration, ' sec') FROM silver.erp_CUST_AZ12
UNION ALL
SELECT 'erp_LOC_A101', COUNT(*), CONCAT(@t5_duration, ' sec') FROM silver.erp_LOC_A101
UNION ALL
SELECT 'erp_PX_CAT_G1V2', COUNT(*), CONCAT(@t6_duration, ' sec') FROM silver.erp_PX_CAT_G1V2
UNION ALL
SELECT '=====================', '=========', '========='
UNION ALL
